            ...
            <div style={styles.modalContent} onClick={e => e.stopPropagation()}>
              <div style={styles.modalHeader}>
                <div>
                  ...
                  <h2 style={{ margin: "5px 0 0 0", color: "var(--text-primary)", fontSize: "20px" }}>Thông Tin Đặt Lịch Chi Tiết</h2>
                </div>
              ...
              <div style={styles.modalBody}>
                <div style={styles.modalGrid}>
                  ...
                  <div style={styles.modalField}>
                    ...
                    <div style={{ marginTop: "5px" }}>
                      <span style={{ ...styles.badge, backgroundColor: getStatusDetails(selectedBooking.Status).bg, color: getStatusDetails(selectedBooking.Status).text, border: `1px solid ${getStatusDetails(selectedBooking.Status).text}` }}>
                ...
                <div style={styles.priceContainer}>
                  ...
                  <div style={{ ...styles.priceRow, borderTop: "1px solid var(--border)", paddingTop: "10px", marginTop: "10px" }}>
